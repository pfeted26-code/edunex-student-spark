...
import { Users, BookOpen, Calendar, TrendingUp, Settings, LogOut } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const stats = [
    { title: 'Total Students', value: '1,234', icon: Users, change: '+12%', color: 'from-primary to-primaryLight' },
    { title: 'Total Teachers', value: '89', icon: Users, change: '+5%', color: 'from-secondary to-accent' },
    { title: 'Active Courses', value: '45', icon: BookOpen, change: '+8%', color: 'from-accent to-primary' },
    { title: 'Attendance Rate', value: '94%', icon: TrendingUp, change: '+3%', color: 'from-primaryLight to-secondary' },
  ];
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { action: 'New teacher registered', user: 'Dr. Sarah Johnson', time: '2 hours ago' },
                { action: 'Course updated', user: 'Mathematics 101', time: '5 hours ago' },
                { action: 'Student enrolled', user: 'John Smith - Physics', time: '1 day ago' },
              ].map((activity, index) => (
